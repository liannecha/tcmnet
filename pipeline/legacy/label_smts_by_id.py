...
dict_df = pd.read_csv("pipeline/legacy/eight_principles_terms.csv")
...
result.to_csv("pipeline/legacy/SMTS_eight_principles_by_id.csv", index=False, encoding="utf-8-sig")